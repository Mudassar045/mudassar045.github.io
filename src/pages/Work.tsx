					...
					<div className="container">
						<div className="columns is-vcentered is-centered">
							<div className="column is-three-fifths is-narrow content">
								...
								<p>
									Most of the time I only do programming, learning about new technologies and explore
									something new every day. Below are some works that I practiced and made demo of
									them.
								</p>
								<h3>Open Source</h3>
								<ul>
									{getWorkLinks('ext').map((work, index) => (
										<li key={'ext' + index}>
											<ExternLink href={work.link} title={work.title} />
										</li>
									))}
								</ul>
								<h3>Practice</h3>
