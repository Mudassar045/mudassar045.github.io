							...
							<div className="column is-three-fifths is-narrow content">
								...
								<div className="control" style={{ margin: '10px 0px' }}>
									<label className="radio">
										<input
											type="radio"
											checked={category === 'idea' ? true : false}
											onChange={e => setCategory('idea')}
										/>
									...
									<label className="radio">
										<input
											type="radio"
											checked={category === 'issue' ? true : false}
											onChange={e => setCategory('issue')}
										/>
									...
									<label className="radio">
										<input
											type="radio"
											checked={category === 'other' ? true : false}
											onChange={e => setCategory('other')}
										/>
...
const NavButton: React.FC<any> = ({ children, ...rest }) => {
	return (
		<button {...rest} className="button has-background-grey has-text-white">
			{children}
		</button>
	)
}
