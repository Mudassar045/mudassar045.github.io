						...
						<div className="container">
							<div className="columns is-vcentered is-centered" style={{ marginBottom: 180 }}>
								<div className="column is-three-fifths is-narrow content">
									...
									<p>
										I value my time, so make it worth, and{' '}
										<a href="https://www.google.com/search?q=succinct+emails">keep it succinct</a>.
									</p>
									<hr />
									...
									<p>
										If the answer to your question could be interesting to others, consider asking
										in my <a href={`${config.userGitHub}/ama`}>AMA</a> instead.
									</p>
								</div>
							</div>
						</div>
