						...
						<div className="container">
							<div className="columns is-vcentered is-centered" style={{ marginBottom: 180 }}>
								<div className="column is-half is-narrow content">
									...
									<p>
										Here is the list of all the tools I use. If I missed a category, just contact me
										and I will make sure to add it.
									</p>
									...
									<ul>
										...
										<li>
											<a href="https://www.microsoft.com/en-pk/p/paint-3d/9nblggh5fv99?activetab=pivot:overviewtab/">
												MS Paint
											</a>
										</li>
									</ul>
									...
									<ul>
										<li>
											<a href="https://www.lenovo.com/pk/en/laptops/thinkpad/thinkpad-e-series/ThinkPad-E580/p/22TP2TEE580">
												Lenovo E580 with Linux Ubuntu
											</a>
										</li>
										<li>
