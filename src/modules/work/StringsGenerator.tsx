							...
							<div className="column is-two-thirds content">
								...
								<div className="box" style={{ marginTop: 10 }}>
									<div className="columns is-half-desktop">
										...
										<div className="column is-one-third has-padding-2">
											<input
												...
												placeholder="e.g. 10"
												onBlur={e => setStringCount(parseInt(e.target.value) || 10)}
											/>
										</div>
									</div>
									<div className="columns is-half-desktop">
										...
										<div className="column is-one-third has-padding-2">
											<input
												...
												className="input is-small is-hovered"
												placeholder="e.g. 10"
												onBlur={e => setStringLength(parseInt(e.target.value) || 10)}
											/>
										</div>
									</div>
									<div className="columns is-half-desktop">
										<div className="column has-text-right">
											<button
												className="button is- is-small has-background-info has-text-white-bis"
									...
									<textarea
										...
										value={outputStrings}
										placeholder="copy strings from here..."
									/>
								</div>
								<div className="box" style={{ marginTop: 10 }}>
									<button
									...
									{toggleCode && (
										<pre>
											<code className="language-javascript">Working on it...will add soon</code>
										</pre>
									)}
								</div>
							</div>
